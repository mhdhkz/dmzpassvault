                  ...
                  <div class="col-md-6 col-lg-12 col-xl-6">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <h6 class="mb-0"><a href="https://grahakarya.com/"
                            class="text-heading">PT Graha Karya Informasi</a></h6>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6 col-lg-12 col-xl-6">
            ...
            <div class="card h-100">
              <div class="card-body">
                ...
                <p class="text-center mb-6">
                  Sudah jadi bagian dari kami? Langsung login.<br
                  ...
                  <div class="col-12">
                    <div class="row g-4 justify-content-center text-center">
                      ...
                      <div class="col-12 col-md-6 col-lg-5">
                        ...
                        <a href="{{ url('/register') }}" class="btn btn-secondary w-100" target="_blank">
                      ...
                      <div class="col-12 col-md-6 col-lg-5">
                        ...
                        <a href="{{ url('/login') }}" class="btn btn-primary w-100" target="_blank">
